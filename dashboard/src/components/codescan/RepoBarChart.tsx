...
import type { CodescanStatsResponse } from '../../api/codescan'
...
// リポジトリ別件数の棒グラフ（上位8件、DEPSCANのRepoBarChartと同じ構成）
export function RepoBarChart({ stats, loading }: { stats: CodescanStatsResponse | null; loading: boolean }) {
